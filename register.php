...
<?php
//Forbidden access to the register page from the url.
if(isset($_SESSION['username'])){
  header("location : index.php");
}
// Inserting username, email and hashed password to the table user in our database auth-sys.
...
<main class="form-signin w-50 m-auto">
  <form method="POST" action="register.php">
    ...
    <h1 class="h2 mt-5 fw-normal text-primary text-center">Register</h1>
